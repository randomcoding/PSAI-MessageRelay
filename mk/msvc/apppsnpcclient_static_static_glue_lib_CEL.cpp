...
#endif
struct CS_EXPORT_SYM _Bind_psnpcclient_static_plugins_CEL
{
  _Bind_psnpcclient_static_plugins_CEL ();
};
struct _static_use_CEL { _static_use_CEL (); };
_Bind_psnpcclient_static_plugins_CEL::_Bind_psnpcclient_static_plugins_CEL () {}
// Needed to pull in _cs_static_use object file
namespace { _static_use_CEL _static_use_CEL_bind; }
